...
L.ColorIcon = L.DivIcon.extend({
  ...
  initialize: function (options) {
	...
	let shadowHtmlStyle = `
	  ...
	  margin-top: ${(this.options.shadowAnchor[1])}px;
	  margin-left:${(this.options.shadowAnchor[0])}px;
	  `; 
	...
	let alertHtmlStyle = `
	  position: absolute;
      width : ${(this.options.iconSize[0])+20}px;
      height : ${(this.options.iconSize[1])+20}px;
      left: -${(this.options.iconSize[0]/2)+10}px;
      top: -${(this.options.iconSize[1]/2)+10}px;
      ${this.options.filter}`;	


    this.options.html = `
	<img src="${this.options.shadowUrl? this.options.shadowUrl: 'img/blank.png'  }" style="${this.options.shadowUrl?shadowHtmlStyle:''}" />
	<img src="${this.options.iconUrl}" style="${markerHtmlStyle}" />
	<img src="${this.options.alertIconUrl? this.options.alertIconUrl: 'img/blank.png'  }" style="${this.options.alertIconUrl?alertHtmlStyle:''}" />
	`;
